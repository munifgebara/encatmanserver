...
@Configuration
@ComponentScan(basePackages = {"br.com.munif", "gumga.framework"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.munif", "gumga.framework"})
...
//        config.addDataSourceProperty("url", "jdbc:mysql://localhost:3306/encatman?zeroDateTimeBehavior=convertToNull");
...
//        config.addDataSourceProperty("password", "senha");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("gumga.framework.domain","br.com.munif");
